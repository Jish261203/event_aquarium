...
const EventDetails = async ({ params: { id }, searchParams }: SearchParamProps) => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="relative overflow-hidden rounded-lg col-span-2 md:col-span-2 h-96"> <Image
              src={event.imageUrl}
              alt="hero image"
              layout="fill"
              objectFit="cover"
          ...
          <div className="flex gap-2 md:gap-3 items-center">
            ...
            />
                 <p className="text-lg">
                  ...
                  {formatDateTime(event.startDateTime).dateOnly === formatDateTime(event.endDateTime).dateOnly ? '' : ` - ${formatDateTime(event.endDateTime).dateOnly}`}
                </p>
          </div>
          <div className="flex gap-2 md:gap-3 items-center">
            <Image
